  ...
  <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6">
        ...
        <div>
          <label for="name" class="block text-sm font-medium leading-6 text-gray-900">First_Name</label>
          <div class="mt-2" >
            <input id="name" name="name" type="text" autocomplete="email" required class="block w-full rounded-md border-0 py-1.5 text-grey-1000 shadow-sm ring-1 ring-inset ring-sky-400 placeholder:text-sky-400 focus:ring-2 focus:ring-inset focus:ring-sky-400 sm:text-sm sm:leading-6"/>
          </div>
        </div>

        <div>
          <label forName="name" className="block text-sm font-medium leading-6 text-gray-900">Last_Name</label>
          <div class="mt-2" >
            <input id="name" name="name" type="text" autocomplete="email" required class="block w-full rounded-md border-0 py-1.5 text-grey-1000 shadow-sm ring-1 ring-inset ring-sky-400 placeholder:text-sky-400 focus:ring-2 focus:ring-inset focus:ring-sky-400 sm:text-sm sm:leading-6"/>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-2">
            <input id="address" name="address" type="text" autocomplete="address" required class="block w-full rounded-md border-0 py-1.5 text-gray-1000 shadow-sm ring-1 ring-inset ring-sky-400 placeholder:text-sky-400 focus:ring-2 focus:ring-inset focus:ring-sky-400 sm:text-sm sm:leading-6"/>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-2">
            <input id="qualification" name="qualification" type="text" autocomplete="qualification" required class="block w-full rounded-md border-0 py-1.5 text-gray-1000 shadow-sm ring-1 ring-inset ring-sky-400 placeholder:text-sky-400 focus:ring-2 focus:ring-inset focus:ring-sky-400 sm:text-sm sm:leading-6"/>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-2">
            <input id="skills" name="skills" type="text" autocomplete="skills" required class="block w-full rounded-md border-0 py-1.5 text-gray-1000 shadow-sm ring-1 ring-inset ring-sky-400 placeholder:text-sky-400 focus:ring-2 focus:ring-inset focus:ring-sky-400 sm:text-sm sm:leading-6"/>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-2">
            <input id="dateofbirth" name="dateofbirth" type="date" placeholder="dd-mm-yyyy" required class="block w-full rounded-md border-0 py-1.5 text-gray-1000 shadow-sm ring-1 ring-inset ring-sky-400 placeholder:text-sky-400 focus:ring-2 focus:ring-inset focus:ring-sky-400 sm:text-sm sm:leading-6"/>
          </div>
        </div>
        ...
        <div>
        <label for="resume" class="block text-sm font-medium leading-6 text-gray-900">Resume</label>
