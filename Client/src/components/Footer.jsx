        ...
        <footer id="ContactUs" className="bg-sky-200 text-blue-950 pr-[50px] pl-[50px]">
            ...
            <div className="md:items-start max-md:text-center md:justify-between md:flex sm:px-12 px-4 py-4 ">
                <div className="p-2 mb-2">
                    <span className="font-bold font-serif underline ">Contact Us</span>
                    <ul>
                        <li className=" py-1">
                            <a href="https://goo.gl/maps/mp27N3bQBSAXym4D7" rel="noreferrer" target="_blank" >
                                <p className="flex gap-1 items-center max-md:justify-center">
                                    ...
                                    Manit, Bhopal, Madhya Pradesh 462007
                                </p>
                            </a>
                        ...
                        <li className="py-1">
                            <p className="flex gap-1 items-center max-md:justify-center"> 
                                ...
                                innovatetrio@gmail.com
                            </p>
                        </li>
                        <li className="py-1">
                            <a href="https://github.com/dixitudit/Corporate-Recruitment-System" rel="noreferrer" target="_blank">
                            <p className="flex gap-1 items-center max-md:justify-center"> 
                ...
                <div className="p-2 mb-2">
                    <span className="font-bold font-serif ml-2 underline ">For You</span>
                    <ul >
                        <li className="px-2">
                            <Link to="/">
                            <p className="flex gap-1 items-center max-md:justify-center">
                ...
                <div className="p-2">
                    <span className="font-bold font-serif underline">Follow Us</span>
                    <ul >
                        <li className="py-1">
                            <Link to="/404">
                                <p className="flex gap-1 items-center max-md:justify-center"> 
